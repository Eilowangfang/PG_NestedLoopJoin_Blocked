...
typedef struct PlanState
{
    ...
    //TupleTableSlot *ps_MidResultTupleSlot; /* slot for mid result tuples */
...
typedef struct HashState
{
	...
	//Fang
    /* MaterialState used for re-optimization with materilization the collected
     * results before hash. */
