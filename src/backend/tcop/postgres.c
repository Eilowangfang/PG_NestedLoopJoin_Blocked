...
bool lpce_reopt     = false;   //turn on/off re-optimization

bool lpce_check     = false;   //must turn on if re-optimization is on
bool lpce_earlyend  = false;  //detected large error and early end current execution
bool lpce_rerun     = false;  //indicate current execution is rerun

bool test_purpose   = false;
struct card_Runlog card_runLog[NODE_NUM_MAX] ={{0, 0, 0, 0, 0, 0, false, false}};
int node_style[NODE_NUM_MAX] = {0};
