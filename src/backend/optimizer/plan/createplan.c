...
create_scan_plan(PlannerInfo *root, Path *best_path, int flags)
{
    ...
    plan->outer_relids = best_path->parent->relids->words[0];
    //elog(INFO, "     ------> Fang SCAN SCAN relids &&&&&&&&&&&&&&&& %ld", best_path->parent->relids->words[0]);
	/*
					 ...
					 NestPath *best_path)
{
    ...
    //Fang
    join_plan->join.plan.outer_relids = best_path->outerjoinpath->parent->relids->words[0];
    join_plan->join.plan.inner_relids = best_path->innerjoinpath->parent->relids->words[0];
    //elog(INFO, "     ------> Fang NESTED best_path->jpath.outerjoinpath->parent !!!!!!!!!!!!!! %ld", best_path->outerjoinpath->parent->relids->words[0]);
    //elog(INFO, "     ------> Fang NESTED best_path->jpath.innerjoinpath->parent !!!!!!!!!!!!!! %ld", best_path->innerjoinpath->parent->relids->words[0]);
					  ...
					  MergePath *best_path)
{
    ...
    //elog(INFO, "     ------> Fang MERGE best_path->jpath.outerjoinpath->parent %ld", best_path->jpath.outerjoinpath->parent->relids->words[0]);
    //elog(INFO, "     ------> Fang MERGE best_path->jpath.innerjoinpath->parent %ld", best_path->jpath.innerjoinpath->parent->relids->words[0]);
	/*
    ...
    //Fang
    join_plan->join.plan.outer_relids = best_path->jpath.outerjoinpath->parent->relids->words[0];
    join_plan->join.plan.inner_relids = best_path->jpath.innerjoinpath->parent->relids->words[0];
					 ...
					 HashPath *best_path)
{
	...
	hashclauses = get_switched_clauses(best_path->path_hashclauses,
									   best_path->jpath.outerjoinpath->parent->relids);
    //elog(INFO, "     ------> Fang best_path->jpath.outerjoinpath->parent !!!!!!!!!!!!!! %ld", best_path->jpath.outerjoinpath->parent->relids->words[0]);
    //elog(INFO, "     ------> Fang best_path->jpath.innerjoinpath->parent !!!!!!!!!!!!!! %ld", best_path->jpath.innerjoinpath->parent->relids->words[0]);
	/*
	...
	hash_plan = make_hash(inner_plan,
						  ...
						  skewInherit);
    //Fang
    hash_plan->plan.outer_relids = best_path->jpath.innerjoinpath->parent->relids->words[0];
