...
ExecInitCteScan(CteScan *node, EState *estate, int eflags)
{
    ...
    elog(INFO,"     ------>------> Fang ExecInitCteScan %d", scanstate->ss.ps.plan->plan_node_id);
	/*
...
{
    elog(INFO,"     ------>------> Fang ExecEndCteScan",node->cteplanstate->plan->plan_node_id);
	/*
	 * Free exprcontext
	 */
...
ExecReScanCteScan(CteScanState *node)
{
    ...
    elog(INFO,"     ------>------> Fang ExecReScanCteScan");
	/*
